...
Immich Kiosk lets you display your [Immich](https://immich.app) photos and videos in highly customizable slideshows that run in browsers and devices.
...
## Requirements
- A reachable Immich server that is running version v3.0.0 or above.
- A supported browser:
  - chrome >= 106
  - edge >= 106
  - opera >= 92
