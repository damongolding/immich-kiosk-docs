...
<Aside type="tip">
    Some devices require a high-current USB-C cable and a USB port capable of supplying sufficient power, not just data.

    This is because the USB-C connection is used for both data transfer and power delivery. If the port cannot provide enough power, the device may not function correctly.
</Aside>
...
If you encounter issues updating the webview on 6.0.1 devices, an alternative method and troubleshooting can be found [here](https://docs.demonwarriortech.com/Documented%20Tutorials/Immich%20Frame/Frameo_Setup/#frameo-troubleshooting)
...
| Model            | Android version | WebView version | Root required | Notes                     | UPC/EAN       |
| ---------------- | --------------- | --------------- | ------------- | ------------------------- | ------------- |
| Yenock ZN-DP1101 | 13              | v101.0.4951.61  | No            | No WebView update needed  | 705252421428  |
| Denver FFP-1037W | 6.0.1           | v44.0.2403.119  | Yes           | WebView update successful | 6152228211264 |
| Moonka ZN-DP1101 | 13              | v106.0.5249.126 | No            | No WebView update needed  | 761426992521  |
| Dxmart 10.1" HD  | 13              | v109.0.5414.86  | No            | No WebView update needed  | 705252421855  |
| Pastigio M15R5   | 8.0.1           | v61             | Yes           | WebView update succsesful |               |
