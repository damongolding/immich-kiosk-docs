...
<Aside type="note">
    Frameo devices tend to be low-powered with limited resources. It is recommended to disable any [image effects](/configuration/image-effects/) and depending on your device you may need to enable [optimize_images](/configuration/behavior/#optimize-images).
</Aside>
