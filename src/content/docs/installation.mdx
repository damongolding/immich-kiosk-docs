...
<Steps>
  ...
  2. Download `docker-compose.yaml`.
     ...
     Set `Lang` to a `language code` from [this list](https://raw.githubusercontent.com/damongolding/immich-kiosk/refs/heads/main/assets/locales.md)
...
<Aside type="note">
    As of Immich `v1.137.0`, your API key can have fine-grained permissions.
</Aside>
...
If you do not intend to use the like/hide buttons, you can remove the following permissions:
