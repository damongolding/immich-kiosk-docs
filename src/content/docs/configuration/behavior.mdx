...
<Aside type="note">
    This feature requires Kiosk to be served over https 
</Aside>
...
<Aside type="note">
    In most cases this is not necessary, but if you are accessing Kiosk on a low-powered device, this may help.
</Aside>
