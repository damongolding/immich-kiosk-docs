...
<Aside type="caution">
    If you are looking to modify existing collections/pools e.g. filter all assets of person X to only show assets from the last 30 days. You should use the [date filter instead](/configuration/filters/#date-filter).
</Aside>
