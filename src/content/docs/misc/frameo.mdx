...
<Aside type="tip" title="Recommended Android Version">
    Frameo devices running Android 13 or newer provide the best experience for Kiosk. They typically come with a modern WebView (version 101 or higher), deliver better performance, and don’t require root access or WebView updates. Installation is fast and simple.
</Aside>

### Tested Devices

| Model | Marketing Name | Android | Firmware | WebView | Root Required | WebView Update |
|-------|----------------|---------|----------|---------|---------------|----------------|
| **ZN-DP1101** | Yenock Frameo | 13 | BND-A133-1101-20241127 | v101.0.4951.61 | ❌ No | ❌ Not needed |
| Older models | Various | 6.0.1 | Various | v80-v100 | ✅ Yes | ✅ Required |
